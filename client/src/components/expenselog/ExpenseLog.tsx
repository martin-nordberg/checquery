...
const ExpenseLog = (props: ExpenseLogProps) => {
    ...
    // Report line items to parent when expense log data loads/changes
    createEffect(() => {
                ...
                <div ref={tableContainerRef} class="bg-white shadow-lg rounded-lg overflow-auto flex-1">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <Show when={isAddingNew()}>
                            <NewExpenseLogTransactionRow
                                currentAccountName={expenseLog()!.accountName}
                        ...
                        <For each={expenseLog()?.lineItems}>
                            {(lineItem) => (
                                <EditableExpenseLogRow
                                    lineItem={lineItem}
                                    currentAccountName={expenseLog()!.accountName}
                    ...
                    <Show when={expenseLog()?.lineItems.length === 0 && !isAddingNew()}>
