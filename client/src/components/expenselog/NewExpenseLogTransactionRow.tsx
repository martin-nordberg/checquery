...
type NewExpenseLogTransactionRowProps = {
...
const NewExpenseLogTransactionRow = (props: NewExpenseLogTransactionRowProps) => {
...
export default NewExpenseLogTransactionRow
