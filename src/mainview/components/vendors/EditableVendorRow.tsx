...
/**
 * Edit form for an existing vendor: name, description, default account, isActive. Every vendor field is
 * patchable here -- no immutable-after-creation field to omit, unlike accounts.
 *
